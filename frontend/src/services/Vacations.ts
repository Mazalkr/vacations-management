...
class Vacations {
    ...
    public async getActiveVacations(pagination: Pagination): Promise<Vacation[]> {
        const response = await axios.get<Vacation[]>(`${appConfig.activeVacationsUrl}/${pagination.page}/${pagination.limit}`);
